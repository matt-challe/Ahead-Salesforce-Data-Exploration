create or replace view INTERNAL_SALESFORCE_DATA_ANALYTICS.OPPORTUNITY_ANALYTICS.AVG_NUM_DAYS_TO_OPP_CLOSE_BY_STAGE_AND_YEAR(
	YEAR_OPP_CLOSED,
	AHEAD_PRACTICE,
	NUM_OPPS,
...
final AS (
    ...
    GROUP BY ahead_practice, year_opp_closed
    ORDER BY ahead_practice, year_opp_closed
)
SELECT * FROM final;